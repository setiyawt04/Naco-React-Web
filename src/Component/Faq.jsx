...
function Faq() {
  ...
  return (
    <>
    <div id="Faq" className='z-30 bg-cover bg-center bg-no-repeat top-0 left-0 md:w-full min-h-screen pb-20' style={{backgroundImage:`url(${beachImage})`, backgroundPosition: 'left center', backgroundSize: 'cover'}}>
      <motion.div
        ref={fadeIn}
